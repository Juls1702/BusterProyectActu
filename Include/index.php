...
<head>
    ...
    <title>Login y Register - Proyecto ADSO</title>
        ...
        <main>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="../MovieS/index.html" class="formulario__login">
                    ...
                    <!--Register-->
                    <form action="/register_be.php" method= "POST" class="formulario__register">
                        <h2>Regístrarse</h2>
